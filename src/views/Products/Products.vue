    ...
    return {
      ...
      table: {
        columns: [
          ...
          {prop: 'classify', label: '商品', width: "120"},
          {prop: 'price', label: '价格', width: "60"},
          {prop: 'memberPrice', label: '会员价格', width: "90"},
          {prop: 'imageUrl', label: '图片地址', width: "120"},
          {prop: 'imageSliderUrl', label: '轮播图地址', width: "120"},
          {prop: 'slider', label: '轮播状态', width: "120"},
          {prop: 'enable', label: '上架状态', width: "120"},
          {prop: 'createTimeAsString', label: '创建时间', width: "180"},
          {prop: 'description', label: '描述', align: 'center', fixed: false}
        ]
      },
      url: {
        data: '/product/show/ui/getProducts.do',
        page: '/product/show/ui/getProductsPage.do'
      },
      dialog: {
        addTitle: '新增商品',
        detailTitle: '商品详情',
